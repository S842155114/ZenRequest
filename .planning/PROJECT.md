...
- 定义 v2 的优先方向与 requirement scope
- 评估多 server MCP、agent workflow、本地混合 HTTP + MCP 场景的真实优先级
- 继续保持本地优先、轻量、可检查、可回放的产品取向
...
- [ ] 定义下一 milestone 的 requirements、范围与优先级
- [ ] 评估多 server MCP 与 agent workflow 能力是否进入下一轮里程碑
...
---
*Last updated: 2026-04-13 after v1.3 milestone archive*
