...
- 明确 `v1.2` 或 `v2.0` 的目标边界
- 在 MCP `sampling`、多 server 管理、AI / Agent workflow、协议扩展之间确定优先级
- 继续遵守“先打透真实高频链路，再扩展能力面”的产品策略
...
- [ ] 明确下一 milestone 的能力优先级与边界
- [ ] 评估 MCP `sampling` 的产品边界、安全约束与工作台交互模型
- [ ] 评估多 MCP server 管理是否进入下一个 milestone
...
---
*Last updated: 2026-04-10 after v1.1 milestone completion*
