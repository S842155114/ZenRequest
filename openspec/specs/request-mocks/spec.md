# request-mocks Specification

## Purpose
Define request-local response templates that can be generated from completed responses, edited inside the request workbench, and executed through the existing send flow as mock results.
